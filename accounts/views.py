...
class RepoListView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        params = {'access_token': socialtoken, 'per_page': 100}
...
class RepoCreateView(CreateView):
    ...
    def form_valid(self, form):
        ...
        repo_details = requests.get('https://api.github.com/repos/{}/{}'.format(self.request.user.username, self.object.name), params=params).json()
        ...
        self.object.save()
        return HttpResponse(self.object.pk, content_type="text/plain")
